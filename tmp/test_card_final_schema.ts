...
async function test() {
  console.log('Testing column names for crm_treatment_cards...');
  ...
  if (error) {
    ...
    console.log('Insert SUCCEEDED with expiry_date and NO warranty_expiry_date!');
  }
}
