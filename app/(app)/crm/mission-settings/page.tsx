...
export default function MissionSettingsPage() {
    ...
    return (
        <div className="page-container">
            <PageHeader
                icon={Target}
                title="Thiết lập Nhiệm vụ (Missions)"
                subtitle="Gán chỉ tiêu Ngày/Tuần/Tháng cho từng cá nhân"
                description="Hệ thống CRM • Quản lý mục tiêu hiệu suất cao"
            />
                    ...
                    <div className="lg:col-span-1 space-y-4">
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full pl-12 pr-4 py-3 bg-white border border-gray-200 rounded-2xl font-bold text-sm outline-none focus:border-primary focus:ring-4 focus:ring-primary/20 transition-all"
                            />
                        </div>
