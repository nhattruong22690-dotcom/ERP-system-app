            ...
            <div className="max-w-6xl mx-auto space-y-10">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                    <div>
                        ...
                        <p className="text-xs font-bold text-gray-500 mt-2 uppercase tracking-widest">Theo dõi KPIs & Thu nhập của bạn</p>
                    </div>
                    <div className="flex items-center gap-4 bg-white p-2 rounded-2xl shadow-sm border border-gray-100">
                        <span className="text-xs font-black text-gray-400 uppercase tracking-widest pl-2">Kỳ báo cáo:</span>
                        <input
                            type="month"
                            className="bg-gray-50 border-none rounded-xl text-sm font-bold py-1.5 px-3 focus:ring-2 focus:ring-indigo-500/20"
                            value={period}
