...
import { Plus, Edit2, Shield, Trash2, Building, Store, Search, X, Tag, Star, Heart, Zap, Coffee, MessageSquare, Scissors, DollarSign, Smartphone, User, Palette, Sparkles, Stethoscope, Syringe, UserCheck, Activity, HeartPulse, Microscope, Crown, Clock, ChevronDown, CheckSquare, Square, Check, CheckCircle2 } from 'lucide-react'
...
export default function JobTitlesModal({ onClose }: { onClose: () => void }) {
    ...
    async function handleSave() {
        ...
        const newJt: JobTitle = {
            id: editing?.id ?? `jt_${crypto.randomUUID().split('-')[0]}`,
            name: form.name,
